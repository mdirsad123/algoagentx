...
// Add showCloseButton prop to DialogContent
...
>(({ className, children, showCloseButton = true,...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {showCloseButton && (
        <DialogPrimitive.Close className="absolute right-3 top-3 rounded-full border border-white/10 bg-white/10 p-1.5 text-white opacity-80 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring disabled:pointer-events-none">
          <X className="h-4 w-4" />
