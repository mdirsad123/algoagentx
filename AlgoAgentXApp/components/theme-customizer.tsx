            ...
            {mounted ? (
              <>
                <Button
                  ...
                  className={cn(config.menuPosition === "left" && "border-2 border-primary")}
                >
                  <PanelLeft className="mr-1 -translate-x-1" />
                  Left
                </Button>
                <Button
                  variant={"outline"}
                  ...
                  className={cn(config.menuPosition === "right" && "border-2 border-primary")}
                >
                  <PanelRight className="mr-1 -translate-x-1" />
                  Right
                </Button>
              </>
            ) : (
