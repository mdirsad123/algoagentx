...
function ResetPasswordContent() {
  ...
  const inputClass =
    'h-12 w-full rounded-xl border-white/15 bg-white/10 pl-11 pr-12 text-white placeholder:text-purple-200/60'
    ...
    <AuthShell>
      <div className="min-h-screen w-full flex items-center justify-center p-5 bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950">
        <div className="w-full max-w-md rounded-3xl border border-white/15 bg-white/10 p-6 sm:p-8 shadow-2xl backdrop-blur-2xl">
          ...
          <form onSubmit={submit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 h-4 w-4 -translate-y-1/2 text-purple-200/80" />
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-purple-200"
                >
            ...
            <Button
              disabled={loading}
              className="h-12 w-full rounded-xl bg-gradient-to-r from-fuchsia-500 to-purple-500 font-semibold text-white"
            >
          ...
          <a
            href="/auth/login"
            className="mt-6 block text-center text-sm font-semibold text-purple-200 hover:text-white"
          >
            Back to Login
          </a>
        </div>
  ...
  return (
    <Suspense
      fallback={
        <AuthShell>
          <div className="min-h-screen w-full flex items-center justify-center p-5 bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950">
            <div className="text-sm text-purple-100">Loading reset password page...</div>
          </div>
        </AuthShell>
      }
    >
