...
const adminMenuItems = [
  ...
  { icon: BarChart3, label: "Strategies", href: "/admin/strategies" },
  { icon: PlayCircle, label: "Backtest", href: "/admin/backtest" },
  { icon: History, label: "Backtest History", href: "/admin/backtest-history" },
