...
export const THEME_STYLES_WITH_VARIABLES = `
  .theme-<%- theme %> {
    ...
    --highlight-foreground: <%- colors.light["highlight-foreground"] %>;

    --hover: <%- colors.light["hover"] %>;
    --hover-foreground: <%- colors.light["hover-foreground"] %>;
  ...
  .dark .theme-<%- theme %> {
    ...
    --highlight-foreground: <%- colors.dark["highlight-foreground"] %>;

    --hover: <%- colors.dark["hover"] %>;
    --hover-foreground: <%- colors.dark["hover-foreground"] %>;
...
console.log("✅Themes generations Done!")