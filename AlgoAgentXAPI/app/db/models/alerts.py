...
class PriceAlert(Base):
    ...
    approach_enabled = Column(Boolean, nullable=False, server_default="false")
    approach_distance = Column(Numeric(24, 10), nullable=True)
    approach_state = Column(String(30), nullable=False, server_default="DISABLED")
    last_approach_triggered_at = Column(DateTime(timezone=True), nullable=True)
    approach_trigger_count = Column(Integer, nullable=False, server_default="0")
