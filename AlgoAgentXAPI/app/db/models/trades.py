from sqlalchemy import Column, BigInteger, UUID, Integer, DateTime, String, Numeric, ForeignKey, Index
...
class Trade(Base):
    ...
    backtest_id = Column(UUID(as_uuid=True), ForeignKey("performance_metrics.id"), index=True)
